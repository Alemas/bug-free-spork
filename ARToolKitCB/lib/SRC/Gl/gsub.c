...
//printf("argDispImageTex3 1\n");
#ifdef _WIN32
    if( image == NULL ) {
        arMalloc(image,ARUint8,gImXsize*tex1Ysize*AR_PIX_SIZE_DEFAULT);
    }
//printf("argDispImageTex3 2\n");
    memcpy(image, wimage, gImXsize*gImYsize*AR_PIX_SIZE_DEFAULT);
//printf("argDispImageTex3 3\n");
#endif
